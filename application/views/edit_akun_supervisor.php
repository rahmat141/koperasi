        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url() ?>index.php/Login/lihat_akun_supervisor/<?= $id_petugas?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
        <form action="<?= base_url()?>Login/update_akun_supervisor" method="POST" class="validate">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="hidden" name="id_petugas" class="form-control" value="<?= $id_petugas ?>">
