...
<div class="limiter">
  ...
  <h3>Upload BPKB</h3>
	...
	<form action="<?= base_url() ?>index.php/Login/BPKB_aksi" method="POST" enctype="multipart/form-data">
	<table style="margin: 20px auto;">
		<tbody>
      <tr>
        <td>BPKB</td>
        <td><input type="file" name="bpkb" class="form-control form-control-user" required=""></td>
      </tr>
