    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
                ...
                <center><h1 class="text-gray-800"><b>Jenis Simpanan</b></h1></center>
                <hr> 
                    <!-- Page Heading -->
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <label><a href="<?= base_url() ?>index.php/Simpanan/show_simpananPokokSupervisor/<?= $id_anggota?>">Simpanan Pokok</a></label>
        <br><br>
        <label><a href="<?= base_url() ?>index.php/Simpanan/show_simpananWajibSupervisor/<?= $id_anggota?>">Simpanan Wajib</a></label>
        <br><br>
        <label><a href="<?= base_url() ?>index.php/Simpanan/show_simpananSupervisor/<?= $id_anggota?>">Simpanan Sukarela</a></label>
        <br><br>
        <label><a href="<?= base_url() ?>index.php/Simpanan/lihat_SisaHU/<?= $id_anggota?>">Sisa Hasil Usaha</a></label>
