    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2 mb-4 mb-md-0">
                <img src="<?php echo base_url('gambar/admin.png'); ?>" alt="" class="img-thumbnail rounded mb-2">
            </div>
            <div class="col-md-8 ml-4">
                ...
                <a href="<?= base_url().'/Login/edit_akun_supervisor/'.$id_petugas;?>" class="btn btn-primary btn-block" class="btn btn-sm btn-block btn-primary" ><i class="fa fa-edit"></i> Edit Profile</a>
            </div>
        </div>
    </div>
</div>
