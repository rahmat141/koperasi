    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8 ml-4">
                ...
                <a href="<?= base_url().'/Login/edit_akun_petugas/'.$id_petugas;?>" class="btn btn-primary btn-block" class="btn btn-sm btn-block btn-primary" ><i class="fa fa-edit"></i> Edit Profile</a>
            </div>
        </div>
    </div>
</div>
