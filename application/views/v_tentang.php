  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
              ...
              <div class="col-sm">
                ...
                <div class="card shadow mb-2">
                  ...
                  <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                    <h6 class="m-0 font-weight-bold text-primary">Tentang Koperasi Bunga Biraeng</h6>
                  </a>
                    ...
                    <div class="card-body" align="justify-content-center">
                      ...
                      <div class="row" style="text-align: center;">
                        <div class="col-md-6 mb-4">
                          <img src="<?= base_url() . 'asset/foto/foto_koperasi.jpeg' ?>" style="width: 580px; height: 500px;">
                        </div>
                        <div class="col-md-6 mb-4">
                          <img src="<?= base_url() . 'asset/foto/foto_koperasi2.jpeg' ?>" style="width: 580px; height: 500px;">
                        </div>
                      </div>
                      <h5>Kontak Kami :</h5>
                      <p>085242730820</p>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDLg_imJcax6W9Jl6XkJxq1j-6lzkV1Ys&callback=initMap&libraries=&v=weekly" async>
        </script>
        <style type="text/css">
          #map {
            height: 400px;
