    ...
    <div class="col-md-8">
        ...
        <form action="<?= base_url()?>Login/update_akun" method="POST" class="validate">
          <table style="margin: 20px auto;">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="username">Password</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= $nama ?>" name="nama" id="nama" type="text" class="form-control" placeholder="Nama Lengkap...">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= $nik ?>" name="nik" id="nik" type="number" class="form-control" placeholder="NIK...">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= $no_hp ?>" name="no_hp" id="no_hp" type="number" class="form-control" placeholder="Nomor HP...">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-address-book-o"></i></span>
                            </div>
                            <input value="<?= $alamat ?>" name="alamat" id="alamat" type="text" class="form-control" placeholder="Alamat...">
