  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <center><h1 class="text-gray-800"><b>RIWAYAT SIMPANAN POKOK</b></h1></center>
        <hr><hr>   
      ...
      <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
          <thead align="center">
                            ...
                            <tr>
                              ...
                              <th class="text-gray-800">No. Agt</th>
                              <th class="text-gray-800">No. Simp</th>
                              <th class="text-gray-800">Nama</th>
                              <th class="text-gray-800">Jumlah Simp</th>
                              <th class="text-gray-800">Tanggal Simp</th>
                              ...
                              <tr>
                                 ...
                                 <td align="right" class="text-gray-800">Rp<?php echo number_format($data->nominal,0,',','.') ?></td>
                                 <td class="text-gray-800"><?php echo $data->tanggal_simpanan; ?></td>
                                 <td align="center" class="text-gray-800"><a href="<?= base_url().'index.php/Simpanan/editsimpananPokokS/'.$data->id_simpanan.'/'.$data->id_anggota;?>" class="btn btn-primary">Edit</a>-<a href="<?= base_url().'index.php/Simpanan/hapussimpananPokok/'.$data->id_simpanan.'/'.$data->id_anggota;?>" onclick="return confirm('Anda Yakin Menghapus Simpanan ?')" class="btn btn-danger">Hapus</a>-<a href="<?= base_url().'index.php/Simpanan/bukti_simpanan/'.$data->id_simpanan;?>" class="btn btn-success">Bukti</a></td>
                                        </tr>
                                    <?php $i++; ?>
                                    <?php }?>
                                  </tbody>
