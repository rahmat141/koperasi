...
<center>
  ...
  <div class="form-group">
    <tr>
        <td>Jumlah</td> 
            <td>
                <input type="text" name="jumlah" class="form-control form-control-user" value="<?php echo $x->jumlah ?>>
            </td>
        </td>
    </tr>
    </tr>
  ...
  <div class="form-group">
    <tr>
        <td>Tanggal Keluar</td> 
            <td>
                <input type="date" name="tgl_keluar" class="form-control form-control-user" value="<?php echo $x->tgl_keluar ?>">
            </td>
        </td>
    </tr>
    </tr>
