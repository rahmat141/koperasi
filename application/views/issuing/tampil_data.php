        ...
        <form method='GET' enctype="multipart/form-data">
           ...
           <?php foreach($issuing as $x) { ?>
                <tr>
                    ...
                    <td><?php echo $x->tgl_keluar; ?></td>
                    <!-- <td>
                        <a href="<?= site_url('issuing_controller/hapus/'. $x->id_issuing) ?>" onclick="return confirm('Anda Yakin Menghapus Data ?')" ><button class="btn btn-light"><i class="fa fa-trash"></i></button>  </a>
                    </td> -->
                </tr>
            <?php } ?>
            </table>
                <a href="<?= base_url().'index.php/issuing_controller/tambah'?>" class="btn btn-primary">Tambah Data</a>
    </center>
<!-- Footer -->
