 ...
 <body>
   ...
   <title>Form Entry Simpanan</title>
         ...
         <div id="content">
           ...
           <div class="row">
             <div class="col-lg-6 ml-3">
               <div class="card">
                 <div class="card-header text-uppercase"><b>FORM ENTRY SIMPANAN</b></div>
                 <form action="<?= base_url() ?>index.php/Simpanan/simpan_simpanan" method="POST">
                   <div class="card-body">
                     <label>Tanggal Simpanan</label>
                     <input type="text" class="form-control" name="tanggal_simpanan" value="<?php echo date('Y-m-d') ?>" readonly><br>

                     <label>Nama Anggota</label>
                     <select class="form-control" id="id_anggota" name="id_anggota">
                       <option disabled hidden selected>- Pilih Anggota -</option>
                       <?php foreach ($anggota as $row) {

                          echo '<option value="' . $row->id_anggota . '">' . 'AGT-' . $row->id_anggota . ' / ' . $row->nama . '</option>';
                        }
                        ?>
                     </select> <br>
                     ...
                     <select class="form-control" id="id_tipeSimpanan" name="id_tipeSimpanan">
                       <option disabled hidden selected>- Pilih Tipe Simpanan -</option>
                     ...
                     <input type="number" class="form-control" name="nominal" id="nominal" min="0" max="2500000" required="" placeholder="Masukkan Jumlah Simpanan">
                   </div>
                   <div class="form-group">
                     <center>

                       <button type="submit" class="btn btn-primary px-5"> SUBMIT</button></a></br>
                       <?php
