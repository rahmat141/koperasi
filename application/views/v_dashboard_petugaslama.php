...
<div class="row">
          <div class="col-xl-4 col-lg-6">
              <div class="card shadow mb-4">
                ...
                <div class="text">
                  <div class="text">
                    <center><img src="<?php echo base_url('gambar/anggota.png')?>" width="100" height="100"><br><br>
           ...
           <div class="col-xl-4 col-lg-6">
              <div class="card shadow mb-4">
                ...
                <div class="text">
                  <div class="text">
                    <center><img src="<?php echo base_url('gambar/pinjaman.png')?>" width="100" height="100"><br><br>
           ...
           <div class="col-xl-4 col-lg-6">
              <div class="card shadow mb-4">
                ...
                <div class="text">
                  <div class="text">
                    <center><img src="<?php echo base_url('gambar/simpanan.png')?>" width="100" height="100"><br><br>
                    <b>Jumlah Simpanan = <?php foreach ($simpanan as $key) { ?>
