...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
        <form action="<?= base_url().'index.php/Simpanan/simpan_ambilWajib/'.$id_anggota;?>" method="POST">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input name="nominal" id="nominal" type="number" class="form-control" placeholder="nominal...">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
