...
<div class="limiter">
  ...
  <h3>Upload BPKB->Upload STNK</h3>
	...
	<form action="<?= base_url() ?>index.php/Login/STNK_aksi" method="POST" enctype="multipart/form-data">
	<table style="margin: 20px auto;">
		<tbody>
      <tr>
        <td>STNK</td>
        <td><input type="file" name="stnk" class="form-control form-control-user" required=""></td>
      </tr>
