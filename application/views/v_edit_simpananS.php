        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url() ?>index.php/Simpanan/show_simpananSupervisor/<?= $id_anggota?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
        <form action="<?= base_url() ?>index.php/Simpanan/updateSimpanan/<?= $id_anggota?>" method="POST" enctype="multipart/form-data">
