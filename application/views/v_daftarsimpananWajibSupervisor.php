          ...
          <thead align="center">
                            ...
                            <tr>
                              ...
                              <tr>
                                 ...
                                 <td align="center" class="text-gray-800"><a href="<?= base_url().'index.php/Simpanan/editsimpananWajibS/'.$data->id_simpanan.'/'.$data->id_anggota;?>" class="btn btn-primary">Edit</a>-<a href="<?= base_url().'index.php/Simpanan/hapussimpananWajib/'.$data->id_simpanan.'/'.$data->id_anggota;?>" onclick="return confirm('Anda Yakin Menghapus Simpanan ?')" class="btn btn-danger">Hapus</a>-<a href="<?= base_url().'index.php/Simpanan/bukti_simpanan/'.$data->id_simpanan;?>" class="btn btn-success">Bukti</a></td>
                                        </tr>
                                    <?php $i++; ?>
                                    <?php }?>
                                  </tbody>
