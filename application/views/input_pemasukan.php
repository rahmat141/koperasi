...
<body>
    ...
    <br>
    <form action="<?php echo base_url().'Cashflow/simpan_pemasukan/'; ?>" method="post">
    ...
    <div class="form-group">
      <input type="text" name="pemasukan" class="form-control form-control-user" placeholder="Jumlah Pemasukan"></td>
    </div>
    <div class="form-group">
