				...
				<div class="limiter">
					<div class="container-login100">
						<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
							<center>
								<h1 class="text-gray-800"><b>Pelunasan</b></h1>
								<hr>
								<hr>
								<?php
								// var_dump($jml_angsuran);
								$jumlah_pinjaman = $data_pinjaman['jml_pinjaman'];

								$jangka_waktu = $bulann - 1;

								$bunga = $data_pinjaman['bunga'] / 100;
								...
								// var_dump($pinjaman);
								?>
								<form action="<?= base_url() ?>index.php/Angsuran/aksi_bayar" method="POST" enctype="multipart/form-data">
									<?php foreach ($pinjaman as $p) { ?>
										<table>
											...
											<div class="form-group">
												<tr>
													<td>Nominal</td>
													<td><input type="text" name="nominal" class="form-control form-control-user" value=<?= $p->angsuran ?> readonly></td>
												</tr>
											</div>
											<div class="form-group">
												<tr>
